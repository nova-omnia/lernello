...
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, property = "type") // Changed from actionType to type
@JsonSubTypes({
...
public sealed interface BlockActionDTO
        permits AddBlockActionDTO, ReorderBlockActionDTO, RemoveBlockActionDTO {
}