...
@Mapper(componentModel = "spring", uses = {LearningUnitMapper.class, JsonNullableMapper.class}, nullValuePropertyMappingStrategy = NullValuePropertyMappingStrategy.IGNORE, unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface LearningKitMapper {
    ...
    void update(UpdateLearningKitDTO updateLearningKitDTO, @MappingTarget LearningKit learningKit);
}
