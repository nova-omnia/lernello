...
public class EmailService {
    ...
    public void sendLearningKitInvitation(User user, LearningKit learningKit) {
        try {
            ...
            MimeMessage mime = buildMimeMessage(
                user.getUsername(),
                "Learning‑Kit Invitation: " + learningKit.getName(),
                buildLearningKitTextContent(user, learningKit, plainPassword),
                buildLearningKitHtmlContent(user, learningKit, plainPassword)
            );
    ...
    private MimeMessage buildMimeMessage(String to, String subject, String text, String html)
    ...
    private String buildLearningKitHtmlContent(User user, LearningKit kit, String pwd) {
        ...
        return baseHtmlWrapper("""
            ...
            """.formatted(user.getUsername(), kit.getName(), kit.getDescription(), kit.getDeadlineDate(),
            kit.getContext(), kitUrl, passwordBlock, kitUrl, kitUrl));
    }
    ...
    private String buildLearningKitTextContent(User user, LearningKit kit, String pwd) {
        ...
        return """
                ...
                Open the kit → %s%s
            """.formatted(user.getUsername(), kit.getName(), kit.getDescription(), kit.getDeadlineDate(),
            kit.getContext(), "https://lernello.vercel.app/learningkit/" + kit.getUuid(), pwdLine);
    }
